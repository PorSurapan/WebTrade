  ...
  <form action="editprofile.php" method="post" enctype="multipart/form-data">
    ...
    <div class="user-box">
            <select id="role" name="role" required>
                ...
                <option value="sender" <?php if($result['roles']=="ผู้ลงเทรด") echo "selected" ?>>ผู้ลงเทรด</option>
                <option value="receiver" <?php if($result['roles']=="ผู้ขอเทรด") echo "selected" ?>>ผู้ขอเทรด</option>
              </select>
      <?php } ?>
    </div>
    <center>
